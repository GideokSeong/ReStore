        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ItemOrdred_ProductId = table.Column<int>(type: "integer", nullable: true),
                    ItemOrdred_Name = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseketItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaseketItems_Baskets_BasketId",
                        column: x => x.BasketId,
                        principalTable: "Baskets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaseketItems_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseketItems_BasketId",
                table: "BaseketItems",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseketItems_ProductId",
                table: "BaseketItems",
                column: "ProductId");
